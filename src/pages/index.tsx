  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to WFM - Your key to seamless Workflow Management. Streamline, optimize, and automate your business processes with us."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1542744094-24638eff58bb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx3b3JrZmxvd3xlbnwwfHx8fDE2OTgwNzQwNTd8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to WFM - Your key to seamless Workflow Management. Streamline, optimize, and automate your business processes with us.`}
            </Text>
            <Box
